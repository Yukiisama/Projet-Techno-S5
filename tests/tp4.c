...
int ei_main(int argc, char** argv)
{
    ...
    //ei_draw_polyline(main_window,points,bl);

    //ei_draw_polyline(main_window,arc(centre,50,0,90),black);
    //ei_draw_polyline(main_window, rounded_frame(&rect, 50, 1), black);
    //ei_draw_polyline(main_window, rounded_frame(&rect,50,2), black);
